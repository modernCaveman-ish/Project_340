...
%type <funcname>: char*
%type <funcbody>: unsigned
%type <funcprefix, funcdef >: symbol*
*/
...
expr:	    			assignexpr {
						...
						| expr DIF expr{
						  	$$ = newexpr(arithexpr_e);
						  	$$->sym = newtemp();
						  	emit(if_noteq_op, $1, $3, $$,0,yylineno);
						}
						...
						| expr GREQ expr	{
						  	$$ = newexpr(arithexpr_e);
						  	$$->sym = newtemp();
						  	emit(if_greatereq_op, $1, $3, $$,0,yylineno);
						}
	
						| expr LESS expr	{
						  	$$ = newexpr(arithexpr_e);
						  	$$->sym = newtemp();
						  	emit(if_less_op, $1, $3, $$,0,yylineno);
						}
						...
						| expr LESSEQ expr	{
						  	$$ = newexpr(arithexpr_e);
						  	$$->sym = newtemp();
						  	emit(if_lesseq_op, $1, $3, $$,0,yylineno);
						}
						...
						| expr GR expr		{
						  	$$ = newexpr(arithexpr_e);
						  	$$->sym = newtemp();
						  	emit(if_greater_op, $1, $3, $$,0,yylineno);
						}
